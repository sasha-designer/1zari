          ...
          <section className="bg-white  space-y-8">
            ...
            <div className="flex flex-col gap-2">
              ...
              <p className="whitespace-pre-line text-sm text-gray-700">
                ...
                <br />
                GS투코리아는 스스로의 만족까지 생각하는 복지중심기업을
                만들어갑니다.
                <br />
                GS리테일로 가는 소분센터(투코리아)에서 사원모집 (지게차,
                입고/출고직)
                <br />
                급여: 2,138,900원 (수습3개월 90%, 월~토 16:00~익일 01:00,
                고정연장근무 있음)
                <br />
                ...
                <br />
                복리후생: 4대보험, 퇴직금, 연차, 중식제공, 기숙사(2인1실, 공과금
                포함 본인부담 13만원)
                <br />
                자격조건
                <br />
                ...
                - 장기근무 가능자
                <br />
                - 20대~50대, 6개월 이상 가능자, 12개월 선호함, 주말근무 근무시간
                준수할 수 있는 자<br />
                모집직종
                <br />

...
import CompanyTerm from "@/assets/terms/CompanyTerms";
...
const termsList: TermsItem[] = [
  { id: "companyterm", label: "기업회원 이용약관", Component: CompanyTerm },
  { id: "Privacy", label: "개인정보 처리방침", Component: Privacy },
  { id: "location", label: "위치기반 서비스 이용약관", Component: Location },
];

export default function CompanyTermsAgreement({ onAllAgreedChange }: Props) {
